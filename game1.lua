...
function scene:createScene( event )
    ...
    obj = display.newText("Back", 0, 0, native.systemFont, 32)
    obj:setTextColor(255)
    obj.x = _W*.5; obj.y = _H*.5
    obj:addEventListener( "touch", objTouch )
...
function scene:exitScene( event )
    ...
    obj:removeEventListener( "touch", objTouch )
    -----------------------------------------------------------------------------
